...
},{"./pebble.js":2,"./select.js":3}],2:[function(require,module,exports){
'use strict';

var getQueryParam = function getQueryParam(variable, defaultValue) {
...
module.exports.sendObjectToPebble = function (object) {
...
var getNetworks = function getNetworks(callback) {
    var networks_adress = 'https://api.citybik.es/v2/networks';
    request(networks_adress, function (err, response, body) {
        if (err) {
            callback(err);
            return;
        }
...
var calc_distance = function calc_distance(lat1, long1, lat2, long2) {
 ...
 * @param {networks} : 
 */
var populateSelect = function populateSelect(select, networks) {
    async.map(networks, function (item, callback) {
...
var calcDistanceForEachNetworks = function calcDistanceForEachNetworks(networks, coords, callback) {
    async.map(networks, function (item, callback) {
        item.distance = calc_distance(coords.latitude, coords.longitude, item.location.latitude, item.location.longitude);
        callback();
    }, callback);
};

module.exports.populateSelectByDistance = function (selectID) {
    var results = [];
    async.parallel([getLocation, getNetworks], function (err, res) {
        var coords = res[0];
        var networks = res[1].networks;

        calcDistanceForEachNetworks(networks, coords, function (err, res) {
...
module.exports.getCurrentValue = function (selectID) {
